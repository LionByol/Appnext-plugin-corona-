...
| __See also__         | [appnext.setProgressColor()](setProgressColor.markdown)


## Overview

Relevant for FullScreen/Rewarded ads only. Get the previously set color for the ad's video player's progress bar.

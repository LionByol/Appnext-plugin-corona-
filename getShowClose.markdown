...
| __See also__         | [appnext.setShowClose()](setShowClose.markdown)


## Overview

Relevant for FullScreen/Rewarded ads only. Get the previously set display or hide the "x" (close) button for the ad.

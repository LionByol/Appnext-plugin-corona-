...
| __See also__         | [appnext.getVideoLength()](getVideoLength.markdown)


## Overview

Effects FullScreen/Rewarded ads only. Set video length - 15 or 30 seconds long (default is 15). Possible values:"15", "30", "default".
...
##### videoLength <small>(required)</small>
_[String](http://docs.coronalabs.com/api/type/String.html)._ The prefered video length to be set for the ad.

...
| __See also__         | [appnext.setRewardsAmountRewarded()](setRewardsAmountRewarded.markdown)


## Overview

Relevant for Rewarded ads only. Get the previously set amount of currency for the ad.

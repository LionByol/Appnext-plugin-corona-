...
| __See also__         | [appnext.setPreferredOrientation()](setPreferredOrientation.markdown)


## Overview

Relevant for FullScreen/Rewarded ads only. Get the previously set preferred orientation for the ad.

...
| __See also__         | [appnext.getShowClose()](getShowClose.markdown)


## Overview

Effects FullScreen/Rewarded ads only. Display or hide the "x" (close) button.
...
##### showClose <small>(required)</small>
_[Boolean](http://docs.coronalabs.com/api/type/Boolean.html)._ Display or hide the "x" (close) button.

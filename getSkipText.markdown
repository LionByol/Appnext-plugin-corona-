...
| __See also__         | [appnext.setSkipText()](setSkipText.markdown)


## Overview

Relevant for Interstitial ads only. Get the previously set custom text for the "skip" button of an Interstitial ad.

...
| __Keywords__         | ads, advertising, Appnext, appnext, setButtonText
| __See also__         | [appnext.getButtonText()](getButtonText.markdown)


## Overview

Set the install button's text (default is "Install").
...
##### buttonText <small>(required)</small>
_[String](http://docs.coronalabs.com/api/type/String.html)._ The install button's text for the ad.

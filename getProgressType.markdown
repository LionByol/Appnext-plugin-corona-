...
| __See also__         | [appnext.setProgressType()](setProgressType.markdown)


## Overview

Relevant for FullScreen/Rewarded ads only. Get the previously set progress type for the video player of the ad (default is "clock").

...
| __See also__         | [appnext.getRewardsCustomParameter()](getRewardsCustomParameter.markdown)
...
##### rewardsCustomParameter <small>(required)</small>
_[String](http://docs.coronalabs.com/api/type/String.html)._ The rewards custom parameter to be sent for the ad.

...
| __See also__         | [appnext.getAutoPlay()](getAutoPlay.markdown)


## Overview

Effects Interstitial ads only. Set video auto-play (default is 'true').
...
##### autoPlay <small>(required)</small>
_[Boolean](http://docs.coronalabs.com/api/type/Boolean.html)._ Interstitial with video will auto-play.

...
| __See also__         | [appnext.getButtonColor()](getButtonColor.markdown)


## Overview

Set the install button's color - a 6 hex chars starting with #.
...
##### buttonColor <small>(required)</small>
_[String](http://docs.coronalabs.com/api/type/String.html)._ The install button's color for the ad.

...
| __See also__         | [appnext.setRewardsTransactionId()](setRewardsTransactionId.markdown)


## Overview

Relevant for Rewarded ads only. Get the previously set rewards transaction Id for the ad.
